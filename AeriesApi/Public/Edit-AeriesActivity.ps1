function Edit-AeriesActivity
{
    <#
        ...
        .DESCRIPTION
        The Edit-AeriesActivity cmdlet is used to edit or create an Activity/Award in Aeries for a given StudentID, SchoolCode and Sequence
