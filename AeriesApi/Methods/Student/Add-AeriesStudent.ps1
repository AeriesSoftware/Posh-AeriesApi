function Add-AeriesStudent
{
    ...
    Process {
        ...
        If (![string]::IsNullOrWhiteSpace($NextSchool)) {
            <# String value #>
        ...
        If (![string]::IsNullOrWhiteSpace($LastSchool)) {
            <# String value #>
            $StudentData.LastSchool = $LastSchool
        }
        
        If (![string]::IsNullOrWhiteSpace($ResidenceSchool)) {
            <# String value #>
            $StudentData.ResidenceSchool = $ResidenceSchool
        }
        
        If (![string]::IsNullOrWhiteSpace($NextResidenceSchool)) {
            <# String value #>
